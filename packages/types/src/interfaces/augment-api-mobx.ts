...
import type { CodeInfo, EvmAddress } from '@krypto-wealth/types/interfaces/evm';
import type { CommitmentOf, Era } from '@krypto-wealth/types/interfaces/poc';
...
import type {
  ...
  Slot,
  ValidatorId
} from '@krypto-wealth/types/interfaces/runtime';
...
export interface StorageType extends BaseStorageType {
  ...
  tokens: {
     ...
     **/
    accounts: StorageMap<
      [AccountId | string, CurrencyId | { Token: any } | { DEXShare: any } | { ERC20: any } | string],
      AccountData
    >;
    /**
